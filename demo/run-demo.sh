#!/bin/bash
# Apoyo Demo — Split terminal with tmux
# Left: Apoyo server logs | Right: Claude Code agent
...
# Create new session with the Apoyo server in the left pane
tmux new-session -d -s "$SESSION" -x 200 -y 50 \
  "cd /Users/tkam/Desktop/Coalesce && echo '🟢 Starting Apoyo server...' && npm run dev 2>&1"
